...
\geometry{margin=0.80in} % For including images (optional)
\usepackage{xcolor}
\usepackage{setspace}
\usepackage{titlesec}
\usepackage{fancyhdr}
...
{\LARGE \textbf{Netflix Differ in \textcolor{grun}{Age Ratings} and \textcolor{grun}{Quality}}} \\[1cm]
